...
/**
 * Runs test assertions and counts any thrown {@link AssertionError}s. If the
 * limit is exceeded then the last generated error is thrown.
 * <p>
 * Use this class to fail tests that accumulate too many errors during random
 * repeats, e.g. &gt;5 out of 100.
 * <p>
...
public class TestCounter {
     ...
     * @throws IllegalArgumentException if fraction is not in the range 0-1 or size
     *                                  is not positive
     */
     ...
     *
     * @param failureLimit the failure limit that will generate an AssertionError to
     *                     be thrown
     */
     ...
     * Instantiates a new fail counter.
     *
     * @param failureLimit the failure limit that will generate an
     ...
     *
     * @param test the test
     * @throws AssertionError the assertion error if the failure limit has been
     *                        exceeded
     */
     ...
     * @throws AssertionError            the assertion error if the failure limit
     *                                   has been exceeded
     */
     ...
     *
     * @param test  the test
     * @param error the error (this will be called if the failure limit has been
     *              exceeded)
     * @throws AssertionError the assertion error if the failure limit has been
     *                        exceeded
     */
