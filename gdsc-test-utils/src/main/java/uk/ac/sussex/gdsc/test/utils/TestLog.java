...
public class TestLog {
    ...
    /**
     * Gets the code point (ClassName:MethodName:LineNumber) marking the position
    ...
    /**
     * Gets the code point (ClassName:MethodName:LineNumber) from the stack trace
     * element.
     * <p>
     * Returns an empty string if the element is null avoiding a
     * NullPointerException if the element is not available.
     *
    ...
    /**
     * Gets the stack trace element marking the position where this method was
     * called.
     *
    ...
    /**
     * Gets the stack trace element marking the position a set count of elements
     * before where this method was called.
     *
    ...
    /**
     * Gets the stack trace element marking the call to this method in the stack
     * trace. Optionally offset this by a count of elements to locate a position
     * before this method in the stack trace.
     *
